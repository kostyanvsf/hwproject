...
class Checkout extends React.Component {
  ...
  UserAction() {
    ...
    context.cart.forEach(element => {
      ...
      submitDoc.orderLines.push(listingDoc);
    });
    console.log(submitDoc);

    axios
      .post(`${CONFIG.APIBaseUrl}/listingorder/order`, submitDoc, { headers })
      .then(res => {
        // console.log(res);
    ...
    return (
      <React.Fragment>
        ...
        <Typography variant="subtitle1">
          Your order number is {context.getPlacedOrderId()}. We have emailed
          your order confirmation, and will send you an update when your order
          has shipped.
        </Typography>
      </React.Fragment>
    );
